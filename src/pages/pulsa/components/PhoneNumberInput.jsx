    ...
    <div className="sticky top-[60px] z-10 bg-slate-100 pt-1 pb-4 -mx-4 px-4">
      <Card className={`transition-all duration-300 ${provider ? colorMap[provider.color] : ''}`}>
        <div className="space-y-6">
          <div>
            <h2 className={`text-lg font-semibold ${provider ? 'text-white' : 'text-gray-800'}`}>Masukkan Nomor Tujuan</h2>
            <p className={`text-sm ${provider ? 'text-white/80' : 'text-gray-500'}`}>Pilih nominal pulsa yang Anda inginkan.</p>
          </div>
